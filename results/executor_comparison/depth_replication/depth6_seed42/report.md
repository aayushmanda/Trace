...
|---|---:|---:|---:|
| process | 100.0% | 100.0% | 0.006 |
| outcome | 7.8% | not queried | not defined |
| both | 9.0% | 100.0% | 0.862 |
...
Final mixed-format full-gradient cosine: **0.128**; relative gradient error: **1.027**. These measurements do not by themselves establish a shared mechanism.

...
Fresh pilot: depth 6, seed 44, 2,000 updates, 10,000 unique training circuits and 256 disjoint held-out circuits.
...
|---|---:|---:|---:|
| process | 100.0% | 100.0% | 0.019 |
| outcome | 7.8% | not queried | not defined |
| both | 9.4% | 100.0% | 0.828 |
...
Final mixed-format full-gradient cosine: **0.151**; relative gradient error: **1.277**. These measurements do not by themselves establish a shared mechanism.
...
```bash
python experiments/compare_executor_rules.py --output results/executor_comparison/reproduction --depth 6 --seed 44 --steps 2000 --train-size 10000 --test-size 256 --probe-size 64 --batch-size 128 --d-model 96 --d-ff 192 --lr 0.002 --device cpu --threads 1 --backgrounds 2 --checkpoints 0 100 500 1000 2000
```

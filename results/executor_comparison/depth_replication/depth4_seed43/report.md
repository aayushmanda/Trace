...
| outcome | 21.1% | not queried | not defined |
| both | 27.0% | 100.0% | 0.850 |
...
Final mixed-format full-gradient cosine: **0.010**; relative gradient error: **1.092**. These measurements do not by themselves establish a shared mechanism.

...
|---|---:|---:|---:|
| process | 100.0% | 100.0% | 0.002 |
| outcome | 19.5% | not queried | not defined |
| both | 27.7% | 99.8% | 0.825 |
...
Final mixed-format full-gradient cosine: **0.074**; relative gradient error: **1.016**. These measurements do not by themselves establish a shared mechanism.

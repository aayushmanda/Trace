...
| `outcome_local/` | Prior smoke dump (superseded by `causal_identification/`) |
| `causal_identification/` | Mechanism test: deep outcome, probes + nnsight causal patch. Mixed \(\widehat P_g\) is negative transfer, not this cell. |
